...
Try hitting \button\  here to see such a flash appear.

\flash{0.6}{\includegraphics[height=0.8\textheight, width=\textwidth]{parabola.png}}
...
As you go to the next segment by hitting \button, the
``flash''ed component disappears.
